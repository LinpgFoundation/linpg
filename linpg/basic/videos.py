# 尝试导入opencv和ffmpeg
_LIBS_INITIALIZED: bool = False

try:
    import cv2  # type: ignore
    from ..lib import FFmpeg

    _LIBS_INITIALIZED = True
except ImportError:
    pass
...
class Videos:
    ...
    # 获取视频的音频 （返回路径）
    @classmethod
    def split_audio(cls, input_path: str, audio_format: str = "ogg") -> str:
        # 产生不重名的output文件名称
        ...
        # 生成音频文件
        FFmpeg.convert(input_path, output_path, True)
        # 返回output路径
        return output_path
