...
class EntityDynamicProgressBarSurface(DynamicProgressBarSurface):
    ...
    def load_image():
        ...
        if _BEING_NOTICED_IMG is None:
            _BEING_NOTICED_IMG = IMG.quickly_load(r"Assets/image/UI/eye_orange.png")
        if _FULLY_EXPOSED_IMG is None:
            _FULLY_EXPOSED_IMG = IMG.quickly_load(r"Assets/image/UI/eye_red.png")
        # 警觉图标
        if _ORANGE_VIGILANCE_IMG is None:
            _ORANGE_VIGILANCE_IMG = IMG.quickly_load(r"Assets/image/UI/vigilance_orange.png")
        if _RED_VIGILANCE_IMG is None:
...
class EntityHpBar(DynamicProgressBarSurface):
    ...
    def load_image():
        ...
        if _HP_RED_IMG is None:
            _HP_RED_IMG = IMG.quickly_load(r"Assets/image/UI/hp_red.png")
        if _HP_EMPTY_IMG is None:
            _HP_EMPTY_IMG = IMG.quickly_load(r"Assets/image/UI/hp_empty.png")
