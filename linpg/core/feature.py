...
# 检测图片是否被点击
def is_hover(
    imgObject: object, objectPos: Iterable = Coordinates.ORIGIN, off_set_x: number = 0, off_set_y: number = 0
) -> bool:
    """将会在3.2中弃置"""
...
# 检测图片是否被点击
def is_hovering(imgObject: object, objectPos: Iterable = Coordinates.ORIGIN, off_set: Iterable = Coordinates.ORIGIN) -> bool:
