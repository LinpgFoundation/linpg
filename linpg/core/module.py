...
class GameObject(Coordinate):
    ...
    def set_left(self, value:number) -> None: self.x = int(value)
    #右侧位置
    @property
    def top(self) -> int: return int(self.y)
    def get_top(self) -> int: return int(self.y)
    def set_top(self, value:number) -> None: self.y = int(value)
...
class GameObject2d(GameObject):
    ...
    def get_width(self) -> int: EXCEPTION.fatal("The child class has to implement get_width() function!")
    #高
    @property
    def height(self) -> int: return self.get_height()
    def get_height(self) -> int: EXCEPTION.fatal("The child class has to implement get_height() function!")
    #尺寸
    @property
...
class GameObject2point5d(GameObject):
    ...
    #设置坐标
    def set_pos(self, x:number, y:number, z:number=None) -> None:
        super().set_pos(x,y)
...
class GameObject3d(GameObject2point5d):
    ...
    #设置坐标
    def set_pos(self, x:number, y:number, z:number) -> None:
        super().set_pos(x,y,z)
