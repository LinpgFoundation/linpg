...
class AbstractSystem:
    ...
    #是否本体语言和当前一致
    def language_need_update(self) -> bool: return self._language_when_initialize != Lang.current_language
    #更新语言
    def updated_language(self) -> None: self._language_when_initialize = Lang.current_language
