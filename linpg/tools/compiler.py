...
with open("builder_data_cache.json", "r", encoding="utf-8") as f:
    ...
    # 是否保留c文件
    _keep_c: bool = Data["keep_c"]
    # 是否产生html文件
    _generate_html: bool = Data["generate_html"]
    # 展示所有警告
    _show_all_warnings: bool = Data["show_all_warnings"]
    # 语言版本
    _language_level: str = Data["language_level"]
    # 储存源代码的文件的路径
    _source_folder: str = Data["source_folder"]
    # 需要忽略的文件的关键词
    _ignore_key_words: tuple[str] = Data["ignore_key_words"]
